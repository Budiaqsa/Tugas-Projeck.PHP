			...
			<div class="row">
						...
						<form action="form_belanja.php" method="post">
							...
							<div class="form-group row">
								...
								<div class="col-8">
									...
									<div class="custom-control custom-radio custom-control-inline">
										<input name="produk" required id="produk_1" type="radio" class="custom-control-input" value="Speaker">
										<label for="produk_1" class="custom-control-label">Speaker</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
				...
				<div class="col-4">
					<div class="list-group position-relative">
						...
						<button type="button" class="list-group-item list-group-item-action">Kulkas: 6.000.000</button>
						<button type="button" class="list-group-item list-group-item-action">Speaker: 1.500.000</button>
						<button type="button" class="list-group-item list-group-item-action">Mesin Cuci: 3.000.000</button>
						<button type="button" class="list-group-item list-group-item-action active" aria-current="true">
						</button>
					</div>
				</div>
